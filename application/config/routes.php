...
//route laporan
$route['laporan-export'] = 'laporan/laporan_export/';
$route['laporan-import'] = 'laporan/laporan_import/';
$route['laporan-checkImport'] = 'importlaporan/upload';
$route['laporan-export'] = 'laporan/laporan_export/';
$route['laporan-det/(:any)'] = 'laporan/laporan_detail/$1';
//akhir route laporan
...
//tanggal laporan
$route['tanggallaporan-det/(:any)'] = 'tanggallaporan/detail/$1';
$route['tanggallaporan-add'] = 'tanggallaporan/tambahdata';
$route['tanggallaporan-ubah/(:any)'] = 'tanggallaporan/ubahdata/$1';
//staff
$route['staff-add'] = 'staff/tambahdata';
$route['staff-det/(:any)'] = 'staff/detail/$1';
$route['staff-ubah/(:any)'] = 'staff/ubahdata/$1';
//bulanan
$route['bulanan-add'] = 'bulanan/tambahdata';
$route['bulanan-det/(:any)'] = 'bulanan/detail/$1';
$route['bulanan-ubah/(:any)'] = 'bulanan/ubahdata/$1';
