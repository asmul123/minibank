	              ...
	              <div class="row">
	                <div class="col-lg-6">
	                  ...
	                  <select class="form-control js-states" name="debet" id="debet">
	                    ...
	                    <option value="siswa" <?php if ($transaksi->debet == 'siswa') {
                                              echo "selected";
                                            } ?>>Siswa</option>
	                    <option value="koperasi" <?php if ($transaksi->debet == 'koperasi') {
                                                  echo "selected";
                                                } ?>>Koperasi</option>
	                    <option value="bulanan" <?php if ($transaksi->debet == 'bulanan') {
                                                echo "selected";
                                              } ?>>bulanan</option>
	                  </select>
	                </div>
	                <div class="col-lg-6">
	                  ...
	                  <select class="form-control js-states" name="kredit" id="kredit">
	                    <option value=" ">Pilih</option>
	                    <option value="siswa" <?php if ($transaksi->kredit == 'siswa') {
                                              echo "selected";
                                            } ?>>Siswa</option>
	                    <option value="koperasi" <?php if ($transaksi->kredit == 'koperasi') {
                                                  echo "selected";
                                                } ?>>Koperasi</option>
	                    <option value="bulanan" <?php if ($transaksi->kredit == 'bulanan') {
                                                echo "selected";
                                              } ?>>bulanan</option>
	                  </select>
	                </div>
