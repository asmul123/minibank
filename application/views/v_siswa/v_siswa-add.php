                ...
                <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" class="form-control" maxlength="10" minlength="10" id="username5" name="nis" required onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <select class="form-control js-states" name="tahun_akademik" required>
                                ...
                                <?php foreach ($tahunaka as $row) : ?>
                                    <option value="<?= $row['id_tahunakademik']; ?>"> ( <?php $tglawal = date_create($row['tglawal']);
                                                                                        echo date_format($tglawal, "Y"); ?> ) - ( <?php $tglakhir = date_create($row['tglakhir']);
                                                                                                                                    echo date_format($tglakhir, "Y"); ?> )</option>
                                <?php endforeach; ?>
                            </select>
                            <span class="fa fa-building-o form-control-feedback"></span>
                        </div>
