                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body p-20">
                            <div class="container-fluid dataNotNull" style="display: none'">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <table id="dataTableSiswa" class="table" cellspacing="0" width="100%" style="width: 100%;">
                                            <thead>
                                                <tr>
            ...
            $('#nis').keyup(function() {
                setTimeout(() => {
                    if ($(this).val().length == 4) {
                        setTimeout(() => {
                            // $(this).blur()
                            $.get(basUrl + 'dashboardsiswa/getSiswaDetail/' + $(this).val(), function(hasil) {
                                if (hasil != 'null') {
                                    $('.table').css('width', '100%')
                                    setTimeout(() => {
                                        $('#hide').hide()
                                    ...
                                    $.get(basUrl + 'dashboardsiswa/getSaldoSiswa/' + data.nis, function(res) {
                                        $('#saldoSiswa').html(formatRupiah(res, "Rp. "))
                                    })
                                    $.get(basUrl + 'dashboardsiswa/detailTransaksi?id=' + data.nis + '&tipe=siswa', function(result) {
                        ...
                        setTimeout(() => {
                            $(this).blur()
                            $.get(basUrl + 'dashboardsiswa/getSiswaDetailRFID/' + $(this).val(), function(hasil) {
                                if (hasil != 'null') {
                                    $('.table').css('width', '100%')
                                    setTimeout(() => {
                                        $('#hide').hide()
